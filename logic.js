...
const Gameboard = () => {  //coordinates (coords) => coords[0] is y, coords[1] is x
    let tables = [];
    let ships =[];
    let missed=[];
    let slotsUsed=[];
    ...
    let placeShip = (ship,coords, direction)=>{ //coords array, direction "horizontal" or "perpendicular"
...
let Computer = (myGameboard) => {
    ...
    function checking(ship, coords,direction){
        if (direction == 'perpendicular'){
            for (let i=0;i<ship.length;i++) {
    ...
    let placeShips = ()=>{
        ...
        if (getRandomInt(0,2) == 0){
            ...
            while (myGameboard.slotsUsed.length!=4){ 
                if (myGameboard.slotsUsed.length>4) {
                 ...
                 myGameboard.placeShip(four, generateNumber([0,7],[0,10],four,'perpendicular'),'perpendicular');
            }
            ...
            while (myGameboard.slotsUsed.length!=4){
                if (myGameboard.slotsUsed.length>4) {
                 ...
                 myGameboard.placeShip(four, generateNumber([0,10],[0,7],four,'horizontal'),'horizontal');}
        ...
        if (getRandomInt(0,2)==0){
            while (myGameboard.slotsUsed.length!=7){
                ...
                myGameboard.placeShip(three1, generateNumber([0,8],[0,10],three1,'perpendicular'),'perpendicular');
            }
        }
        else {
            while (myGameboard.slotsUsed.length!=7){
                if (myGameboard.slotsUsed.length>7) {
                 ...
                 myGameboard.placeShip(three1, generateNumber([0,10],[0,8],three1,'horizontal'),'horizontal');;
            }
        }
        console.log(myGameboard.slotsUsed.length)
        blockNeigbours(myGameboard)
        ...
        if (getRandomInt(0,2)==0){
            while (myGameboard.slotsUsed.length!=10){
                ...
                myGameboard.placeShip(three2, generateNumber([0,8],[0,10],three2,'perpendicular'),'perpendicular');
            }
        }
        else {
            while (myGameboard.slotsUsed.length!=10){
                ...
                myGameboard.placeShip(three2, generateNumber([0,10],[0,8],three2,'horizontal'),'horizontal');
            }
        }
        console.log(myGameboard.slotsUsed.length)
        blockNeigbours(myGameboard)
        ...
        if (getRandomInt(0,2)==0){
            while(myGameboard.slotsUsed.length!=12){
                ...
                myGameboard.placeShip(two1, generateNumber([0,10],[0,9],two1,'horizontal'),'horizontal');
            }
        }
        else {
            while(myGameboard.slotsUsed.length!=12){
                ...
                myGameboard.placeShip(two1, generateNumber([0,9],[0,10],two1,'perpendicular'),'perpendicular');
            }
        }
        console.log(myGameboard.slotsUsed.length)
        blockNeigbours(myGameboard)
        ...
        if (getRandomInt(0,2)==0){
            while(myGameboard.slotsUsed.length!=14){
                ...
                myGameboard.placeShip(two2, generateNumber([0,10],[0,9],two2,'horizontal'),'horizontal');
            }
        }
        else {
            while(myGameboard.slotsUsed.length!=14){
                ...
                myGameboard.placeShip(two2, generateNumber([0,9],[0,10],two2,'perpendicular'),'perpendicular');
            }
        }
        console.log(myGameboard.slotsUsed.length)
        blockNeigbours(myGameboard)
        ...
        if (getRandomInt(0,2)==0){
            while(myGameboard.slotsUsed.length!=16){
                ...
                myGameboard.placeShip(two3, generateNumber([0,10],[0,9],two3,'horizontal'),'horizontal');
            }
        }
        else {
            while(myGameboard.slotsUsed.length!=16){
                ...
                if (myGameboard.placeShip(two3, generateNumber([0,9],[0,10],two3,'perpendicular'),'perpendicular')==Error)myGameboard.placeShip(two3, generateNumber([0,9],[0,10],myGameboard.slotsUsed,two3,'horizontal'),'perpendicular');
            }
        }
        console.log(myGameboard.slotsUsed.length)
        blockNeigbours(myGameboard)
        ...
        if (getRandomInt(0,2)==0){
            while(myGameboard.slotsUsed.length!=17){
                ...
                myGameboard.placeShip(one1, generateNumber([0,10],[0,10],one1,'horizontal'),'horizontal');
            }
        }
        else {
            while(myGameboard.slotsUsed.length!=17){
                ...
                myGameboard.placeShip(one1, generateNumber([0,10],[0,10],one1,'perpendicular'),'perpendicular');
            }
        }
        console.log(myGameboard.slotsUsed.length)
        blockNeigbours(myGameboard)
        ...
        if (getRandomInt(0,2)==0){
            while(myGameboard.slotsUsed.length!=18){
                ...
                myGameboard.placeShip(one2, generateNumber([0,10],[0,10],one2,'horizontal'),'horizontal');
            }
        }
        else {
            while(myGameboard.slotsUsed.length!=18){
                ...
                myGameboard.placeShip(one2, generateNumber([0,10],[0,10],one2,'perpendicular'),'perpendicular');
        }
        }
        blockNeigbours(myGameboard)
        ...
        if (getRandomInt(0,2)==0){
            while(myGameboard.slotsUsed.length!=19){
                ...
                myGameboard.placeShip(one3, generateNumber([0,10],[0,10],one3,'horizontal'),'horizontal');
            }
        }
        else {
            while(myGameboard.slotsUsed.length!=19){
                ...
                myGameboard.placeShip(one3, generateNumber([0,10],[0,10],one3,'perpendicular'),'perpendicular');
            }
        }
        blockNeigbours(myGameboard)
        ...
        if (getRandomInt(0,2)==0){
            while(myGameboard.slotsUsed.length!=20){
                ...
                myGameboard.placeShip(one4, generateNumber([0,10],[0,10],one4,'horizontal'),'horizontal');
            }
        }
        else {
            while(myGameboard.slotsUsed.length!=20){
                ...
                myGameboard.placeShip(one4, generateNumber([0,10],[0,10],one4,'perpendicular'),'perpendicular');
            }
        }
        blockNeigbours(myGameboard)
